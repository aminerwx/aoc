...
func instruction(state string, src Coordinate, dest Coordinate, grid [1000][1000]bool) [1000][1000]bool {
//	fmt.Println(src)
	switch state {
	case OFF:
...
//				fmt.Println(j)
	...
	default:
		fmt.Println("Incorrect state argument")
	}
